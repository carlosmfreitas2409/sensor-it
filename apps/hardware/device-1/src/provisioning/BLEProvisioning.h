...
class BLEProvisioning: public BLECharacteristicCallbacks {
  ...
  public:
    ...
    void init(const char *name, const char *model, const char *snid);
    void set_on_credentials_ready_callback(t_void_func callback);
    void set_networks_scan_callback(t_string_func callback);
